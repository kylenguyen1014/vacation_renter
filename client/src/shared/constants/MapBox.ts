...
export const MAPBOX_QUERY_SEARCH = (text : string) => MAPBOX_GEOCODING_API + `${text}.json?access_token=${MAPBOX_TOKEN}&autocomplete=true&country=us`
export const mapboxInstance = mapboxgl.accessToken = MAPBOX_TOKEN;